<%@ page import="com.Model.DisplayProduct" %>
<%@ page import="java.util.ArrayList" %>
<%@ page import="com.Model.DisplayProductListRes" %>
                ...
                <div class="row">
                    <div class="col justify-content-center">
                        <div class="row">
                            <div class="col text-center my-3 border-bottom">
                                <nav class="navbar navbar-expand-md navbar-light justify-content-center">
                                    <ul class="navbar-nav">
                                        <li class="nav-item">
                                            <a class="nav-link btn btn-info text-white mx-4" href="productList" style="width: 150px;">전체</a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link btn btn-info text-white mx-4" href="productList?category=1" style="width: 150px;">전세</a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link btn btn-info text-white mx-4" href="productList?category=2" style="width: 150px;">월세</a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link btn btn-info text-white mx-4" href="productList?category=3" style="width: 150px;">담보</a>
                                        </li>
                                    </ul>
                                </nav>
                            </div>
                        ...
                        <div class="row">
                            <div class="container">
                                <%
                                    ArrayList<DisplayProduct> productList = ((DisplayProductListRes) request.getAttribute("productList")).getProductList();
                                ...
                                <% } else {
                                    ...
                                    for (int i = start; i < end; i++) {
                                        DisplayProduct product = productList.get(i);
